(function(){
  ...
  */
 /**
  * como esrava somando strings, é possível utilizar os unários para transformar em numero. Para isso, adiciona-se o + antes da variável
  * É possível tbm usar o construtor Number, desde que nao use o new. Assim, ele só converte!
  */
  function sum() {
  ...
  */
  ...
  console.log(sum(1,2,3,4,5,6,7,4,3));
  console.log(sum(1,2,4,3));
  console.log(sum(1,2,3,4,7,4,3));
  ...
  */
  ...
  function justNumbers(numbers) {
    var regex = /(\D+)/g;
    var found = numbers.replace(regex, ',').split(',');
    return found;
  }
